...
const QString BITCOIN_IPC_PREFIX("mimic:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click mimic: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start mimic: click-to-pay handler");
    else
...
{
    // clicking on mimic: URLs creates FileOpen events on the Mac:
